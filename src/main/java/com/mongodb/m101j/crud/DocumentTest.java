...
public class DocumentTest {
    public static void main(String[] args) {
        ...
        BsonDocument bsonDocument = new BsonDocument("str", new BsonString("MongoDB, Hello"))
                                                    ...
                                                    .append("objectid", new BsonObjectId())
                                                    .append("null", new BsonNull())
                                                    .append("embeddedDoc", new BsonDocument("x",
                                                            new BsonInt32(0)))
                                                    .append("list", new BsonArray(
                                                            Arrays.asList(new BsonInt32(1),
                                                                    new BsonInt32(2), new BsonInt32(3))));
        printJson(bsonDocument);
    }
}
